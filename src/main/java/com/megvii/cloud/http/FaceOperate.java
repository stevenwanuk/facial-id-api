...
public class FaceOperate {
     ...
     */
    public FaceOperate(final String apiKey, final String apiSecret, final boolean isInternationalVersion){
        this.apiKey = apiKey;
     ...
     * @throws Exception
     */
    public Response analyzeFace(final String faceTokens, final int returnLandmark, final String returnAttributes) throws Exception {
     ...
     * @throws Exception
     */
    public Response faceGetDetail(final String faceToken) throws Exception {
